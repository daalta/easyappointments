...
$lang['service_and_provider'] = 'Location & Interviewer';
$lang['select_service'] = 'Select Location';
$lang['select_provider'] = 'Select Interviewer';
...
$lang['customer_information'] = 'Participant Information';
...
$lang['customer_details_title'] = 'Participant Details';
$lang['service'] = 'Location';
$lang['provider'] = 'Interviewer';
$lang['customer'] = 'Participant';
$lang['start'] = 'Start';
$lang['end'] = 'End';
$lang['name'] = 'Name';
...
$lang['manage_appointment_record_hint'] = 'Manage all the appointment records of the available interviewers and locations.';
$lang['select_filter_item_hint'] = 'Select an interviewer or a location and view the appointments on the calendar.';
$lang['enable_appointment_sync_hint'] = 'Enable appointment synchronization with interviewer\'s Google Calendar account.';
$lang['manage_customers_hint'] = 'Manage the registered participants and view their booking history.';
$lang['manage_services_hint'] = 'Manage the available locations and categories of the system.';
$lang['manage_users_hint'] = 'Manage the backend users (admins, interviewers, secretaries).';
$lang['settings_hint'] = 'Set system and user settings.';
$lang['log_out_hint'] = 'Log out of the system.';
$lang['unavailable_periods_hint'] = 'During unavailable periods the interviewer won\'t accept new appointments.';
...
$lang['select'] = 'Select';
$lang['hide'] = 'Hide';
$lang['type_to_filter_customers'] = 'Type to filter participants.';
$lang['clear_fields_add_existing_customer_hint'] = 'Clear the fields and enter a new participant.';
$lang['pick_existing_customer_hint'] = 'Pick an existing participant.';
...
$lang['customers'] = 'Participant';
$lang['details'] = 'Details';
$lang['no_records_found'] = 'No records found...';
$lang['services'] = 'Locations';
...
$lang['provider_saved'] = 'Interviewer saved successfully.';
$lang['secretary_saved'] = 'Secretary saved successfully.';
$lang['admin_deleted'] = 'Admin deleted successfully.';
$lang['provider_deleted'] = 'Interviewer deleted successfully.';
$lang['secretary_deleted'] = 'Secretary deleted successfully.';
$lang['service_saved'] = 'Location saved successfully.';
$lang['service_category_saved'] = 'Location category saved successfully.';
$lang['service_deleted'] = 'Location deleted successfully.';
$lang['service_category_deleted'] = 'Location category deleted successfully.';
$lang['customer_saved'] = 'Participant saved successfully.';
$lang['customer_deleted'] = 'Participant deleted successfully.';
...
$lang['sunday'] = 'Sunday';
$lang['breaks'] = 'Breaks';
$lang['add_breaks_during_each_day'] = 'Add the working breaks during each day. During breaks the interviewer will not accept any appointments.';
$lang['day'] = 'Day';
$lang['days'] = 'Days';
...
$lang['edit_breaks_hint'] = 'Add the working breaks during each day. These breaks will be applied for all new interviewers.';
$lang['book_advance_timeout'] = 'Book Advance Timeout';
$lang['book_advance_timeout_hint'] = 'Define the timeout (in minutes) before the participant can book or re-arrange appointments with the company.';
$lang['timeout_minutes'] = 'Timeout (Minutes)';
$lang['about_app_info'] = 'Easy!Appointments is a highly customizable web application that allows your participant to book appointments with you via the web. Moreover, it provides the ability to sync your data with Google Calendar, so you can use them with other services.';
...
$lang['delete_customer'] = 'Delete Participant';
$lang['delete_service'] = 'Delete Location';
$lang['delete_category'] = 'Delete Location Category';
...
$lang['require_captcha_hint'] = 'When enabled, the participants will have to type a random generated CAPTCHA string before booking/updating an appointment.';
$lang['captcha_is_wrong'] = 'CAPTCHA verification failed, please try again.';
$lang['any_provider'] = 'Any Interviewer';
...
$lang['customer_notifications'] = 'Participant Notifications';
$lang['customer_notifications_hint'] = 'Defines whether the participant will receive email notifications whenever there is a schedule change on one of his appointments.';
...
$lang['require_phone_number_hint'] = 'When enabled, participants and users will need to enter the participant\'s phone number when booking an appointment';
...
$lang['overwrite_existing_working_plans'] = 'This will overwrite the existing interviewer working plans, are you sure that you want to continue?';
$lang['working_plans_got_updated'] = 'All the working plans got updated.';
$lang['apply_to_all_providers'] = 'Apply To All Interviewers';
$lang['display_any_provider'] = 'Display Any Interviewer Option';
$lang['display_any_provider_hint'] = 'The booking page will get an additional option that allows participants to book without specifying a interviewer.';
