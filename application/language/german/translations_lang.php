...
// German
$lang['page_title'] = 'Vereinbare ein Interview mit';
$lang['service_and_provider'] = 'Ort & Ansprechpartner';
$lang['select_service'] = 'Auswahl der Ortes';
$lang['select_provider'] = 'Auswahl des Ansprechpartners';
$lang['duration'] = 'Dauer';
$lang['minutes'] = 'Minuten';
$lang['price'] = 'Preis';
$lang['back'] = 'Zurück';
$lang['appointment_date_and_time'] = 'Datum & Uhrzeit des Termins';
$lang['no_available_hours'] = 'Es gibt leider keine freien Termine für das ausgewählte Datum. Bitte wähle ein anderes Datum.';
$lang['appointment_hour_missing'] = 'Bitte wähle einen Termin aus bevor du fortfährst.';
$lang['customer_information'] = 'Teilnehmer-Daten';
...
$lang['appointment_confirmation'] = 'Bitte bestätige die Terminauswahl';
$lang['confirm'] = 'Bestätigung';
$lang['update'] = 'Aktualisierung';
$lang['cancel_appointment_hint'] = 'Bitte klicke auf "Abbrechen" um den Termin aus dem Terminplan zu löschen.';
...
$lang['reason'] = 'Grund';
$lang['appointment_removed_from_schedule'] = 'Der folgende Termin wurde erfolgreich von der Terminplanung storniert.';
$lang['appointment_details_was_sent_to_you'] = 'Eine E-Mail mit den Termindaten ist an dich gesendet worden.';
...
$lang['thank_you_for_appointment'] = 'Vielen Dank für die Terminauswahl. Weiter unten kannst du deine Termindaten sehen. Änderungen können durch Klicken auf den Termin-Link durchgeführt werden.';
$lang['appointment_details_title'] = 'Termindaten';
$lang['customer_details_title'] = 'Teilnehmerdaten';
$lang['service'] = 'Ort';
$lang['provider'] = 'Ansprechpartner';
$lang['customer'] = 'Teilnehmer';
$lang['start'] = 'Beginn';
$lang['end'] = 'Ende';
$lang['name'] = 'Name';
...
$lang['manage_appointment_record_hint'] = 'Verwalten Sie alle Termineintragungen der zur Verfügung stehenden Ansprechpartner und Orten.';
$lang['select_filter_item_hint'] = 'Wählen Sie einen Ansprechpartner oder einen Ort und sehen Sie die Termine im Kalender an.';
$lang['enable_appointment_sync_hint'] = 'Beginnen Sie die Terminsynchronisationen mit dem Google-Kalender des Ansprechpartners.';
$lang['manage_customers_hint'] = 'Verwalten Sie die registrierten Teilnehmer und sehen Sie die vergangenen Buchungen ein.';
$lang['manage_services_hint'] = 'Verwalten Sie die erhältlichen Orte und Kategorien des Systems.';
$lang['manage_users_hint'] = 'Verwalten Sie die Endnutzer (Admins, Ansprechpartner, Büropersonal).';
$lang['settings_hint'] = 'Setzen Sie das System auf Nutzereinstellungen.';
$lang['log_out_hint'] = 'Melden Sie sich vom System ab.';
$lang['unavailable_periods_hint'] = 'In diesem Zeitraum werden neue Termine vom Ansprechpartner nicht akzeptiert.';
...
$lang['select'] = 'Auswahl';
$lang['hide'] = 'Verbergen';
$lang['type_to_filter_customers'] = 'Eingeben, um Teilnehmer zu filtern.';
$lang['clear_fields_add_existing_customer_hint'] = 'Löschen Sie die Felder und geben Sie einen neuen Teilnehmer-Hinweis ein.';
$lang['pick_existing_customer_hint'] = 'Wählen Sie einen vorhandenen Teilnehmer.';
...
$lang['providers'] = 'Ansprechpartner';
...
$lang['admin_saved'] = 'Administrator erfolgreich gespeichert.';
$lang['provider_saved'] = 'Ansprechpartner erfolgreich gespeichert.';
$lang['secretary_saved'] = 'Bearbeiter erfolgreich gespeichert.';
$lang['admin_deleted'] = 'Administrator erfolgreich gelöscht.';
$lang['provider_deleted'] = 'Ansprechpartner erfolgreich gelöscht.';
$lang['secretary_deleted'] = 'Bearbeiter erfolgreich gelöscht.';
$lang['service_saved'] = 'Ort erfolgreich gespeichert.';
$lang['service_category_saved'] = 'Ortskategorie erfolgreich gespeichert.';
$lang['service_deleted'] = 'Ort erfolgreich gelöscht.';
$lang['service_category_deleted'] = 'Ortskategorie erfolgreich gelöscht.';
$lang['customer_saved'] = 'Teilnehmer erfolgreich gespeichert.';
$lang['customer_deleted'] = 'Teilnehmer erfolgreich gelöscht.';
...
$lang['sunday'] = 'Sonntag';
$lang['breaks'] = 'Pausen';
$lang['add_breaks_during_each_day'] = 'Fügen Sie die Arbeitspausen für jeden Tag hinzu. Während der Pausen kann der Ansprechpartner keine Termine akzeptieren.';
$lang['day'] = 'Tag';
$lang['days'] = 'Tage';
...
$lang['edit_working_plan_hint'] = 'Bitte notieren Sie im Folgenden die Tage und Zeiten, für die das Unternehmen Termine anbietet. Sie können Termine auch für Feiertage festlegen aber die Teilnehmer können an diesen Tagen keine Buchung durchführen. Dieser Arbeitsplan ist voreingestellt für alle neuen Einschreibungen von Ansprechpartnern. Sie haben jedoch die Möglichkeit, den Arbeitsplan zu ändern und zwar für jeden Ansprechpartner gesondert, indem Sie seine Einschreibung bearbeiten. Danach fügen Sie die Zeiträume der Pausen hinzu.';
$lang['edit_breaks_hint'] = 'Fügen Sie die betrieblichen Pausen pro Tag hinzu. Diese Pausen werden für alle neuen Ansprechpartner angewendet.';
$lang['book_advance_timeout'] = 'Zeitbegrenzung einer Buchung';
$lang['book_advance_timeout_hint'] = 'Legen Sie eine Zeitbegrenzung (in Minuten) fest, während der die Teilnehmer eine Terminbuchung oder eine Terminänderung durchführen können.';
$lang['timeout_minutes'] = 'Zeitbegrenzung (Minuten)';
$lang['about_app_info'] = 'Easy!Appointments ist eine extrem anpassungsfähige Internet-Applikation, die es Ihren Teilnehmern ermöglicht, einen Termin mit Ihnen über das Internet zu vereinbaren. Darüberhinaus gibt es Ihnen die Möglichkeit, Ihre Daten mit dem Google-Kalender zu synchronisieren, so dass Sie diese mit anderen Ortsprogrammen nutzen können.';
...
$lang['delete_customer'] = 'Teilnehmer löschen';
$lang['delete_service'] = 'Ort löschen';
...
$lang['require_captcha_hint'] = 'Wenn aktiv, werden die Teilnehmer aufgefordert, eine zufällig generierte Zeichenfolge (CAPTCHA) einzutippen bevor Sie einen Termin buchen oder speichern können.';
$lang['captcha_is_wrong'] = 'CAPTCHA-Überprüfung fehlgeschlagen, bitte versuchen Sie es erneut.';
$lang['any_provider'] = 'Beliebiger Ansprechpartner';
...
$lang['customer_notifications'] = 'Teilnehmerbenachrichtigungen';
$lang['customer_notifications_hint'] = 'Stellen Sie ein, ob die Teilnehmer immer dann eine E-Mail-Benachrichtigungen erhalten, wenn sich ein Termin ändert.';
...
$lang['require_phone_number_hint'] = 'Wenn aktiviert, müssen Teilnehmer und Benutzer die Telefonnummer des Teilnehmers beim Buchen eines Termins eingeben';
...
$lang['overwrite_existing_working_plans'] = 'Dies wird bestehende Arbeitspläne von Ansprechpartnern überschreiben. Sind sie sicher?';
$lang['working_plans_got_updated'] = 'Alle Arbeitspläne wurden aktualisiert.';
$lang['apply_to_all_providers'] = 'Auf alle Ansprechpartner anwenden';
$lang['display_any_provider'] = 'Option zum Anzeigen aller Ansprechpartner';
$lang['display_any_provider_hint'] = 'Es wird eine zusätzliche Option zur Buchungsseite hinzugefügt, die es Teilnehmern ermöglicht zu buchen ohne eine spezifischen Ansprechpartner auszuwählen.';
